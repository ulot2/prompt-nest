  ...
  return (
    <div className="max-w-[900px] mx-auto">
      <div className="mt-[1rem]">
        <h1 className="text-2xl font-bold">Discover Powerful AI Prompts</h1>
        <p className="text-gray-600">
          Community-curated prompts for ChatGPT, Claude, Gemini, and more. Find
          the perfect prompt for your needs.
        </p>
      </div>
      <div className="mt-[1rem] w-[350px] flex items-center gap-[0.5rem] border border-gray-300 rounded-lg focus-within:border-gray-600">
